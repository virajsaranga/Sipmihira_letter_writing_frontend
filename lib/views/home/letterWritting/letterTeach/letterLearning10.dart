...
import 'package:story_2/views/home/letterWritting/drawingPage10.dart';

class LearnPage10 extends StatefulWidget {
  const LearnPage10({super.key});

  @override
  State<LearnPage10> createState() => _LearnPage10State();
}

class _LearnPage10State extends State<LearnPage10> {
  @override
            ...
            children: [
              ...
              Image(
                image: AssetImage(AssetsConstants
                    .letterLearning10), // Replace with your image path
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => DrawingPage10()),
                    );
                  },
                  style: ButtonStyle(
