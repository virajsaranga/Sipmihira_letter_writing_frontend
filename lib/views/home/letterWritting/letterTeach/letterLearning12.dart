...
import 'package:story_2/views/home/letterWritting/drawingPage12.dart';

class LearnPage12 extends StatefulWidget {
  const LearnPage12({super.key});

  @override
  State<LearnPage12> createState() => _LearnPage12State();
}

class _LearnPage12State extends State<LearnPage12> {
  @override
            ...
            children: [
              ...
              Image(
                image: AssetImage(AssetsConstants
                    .letterLearning12), // Replace with your image path
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => DrawingPage12()),
                    );
                  },
                  style: ButtonStyle(
