...
import 'package:story_2/views/home/letterWritting/drawingPage9.dart';

class LearnPage9 extends StatefulWidget {
  const LearnPage9({super.key});

  @override
  State<LearnPage9> createState() => _LearnPage9State();
}

class _LearnPage9State extends State<LearnPage9> {
  @override
            ...
            children: [
              ...
              Image(
                image: AssetImage(AssetsConstants
                    .letterLearning9), // Replace with your image path
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => DrawingPage9()),
                    );
                  },
                  style: ButtonStyle(
