...
import 'package:story_2/views/home/letterWritting/drawingPage8.dart';

class LearnPage8 extends StatefulWidget {
  const LearnPage8({super.key});

  @override
  State<LearnPage8> createState() => _LearnPage8State();
}

class _LearnPage8State extends State<LearnPage8> {
  @override
            ...
            children: [
              ...
              Image(
                image: AssetImage(AssetsConstants
                    .letterLearning4), // Replace with your image path
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => DrawingPage8()),
                    );
                  },
                  style: ButtonStyle(
