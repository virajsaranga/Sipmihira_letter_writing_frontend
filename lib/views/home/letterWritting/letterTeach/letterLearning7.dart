...
import 'package:story_2/views/home/letterWritting/drawingPage7.dart';

class LearnPage7 extends StatefulWidget {
  const LearnPage7({super.key});

  @override
  State<LearnPage7> createState() => _LearnPage7State();
}

class _LearnPage7State extends State<LearnPage7> {
  @override
            ...
            children: [
              ...
              Image(
                image: AssetImage(AssetsConstants
                    .letterLearning7), // Replace with your image path
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => DrawingPage7()),
                    );
                  },
                  style: ButtonStyle(
